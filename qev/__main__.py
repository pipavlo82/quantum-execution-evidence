...
def main():
    ...
    sub.add_parser('rvr-demo'); sub.add_parser('rvr-mutation-check'); sub.add_parser('receiptos-demo'); sub.add_parser('tsei-demo'); sub.add_parser('quantum-transpile-demo')
